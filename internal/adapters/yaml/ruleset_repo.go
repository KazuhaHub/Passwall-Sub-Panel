// Package yaml provides file-backed implementations of RuleSetRepo,
// TemplateRepo and XUIPanelRepo, plus loaders for the SAML config file.
//
// rule_sets/ and templates/ are directories with one YAML file per record;
// xui_panels.yaml and saml.yaml are single-document files.
package yaml
...
// RuleSetRepo implements ports.RuleSetRepo.
...
func NewRuleSetRepo(configDir string) (*RuleSetRepo, error) {
	dir := filepath.Join(configDir, "rule_sets")
