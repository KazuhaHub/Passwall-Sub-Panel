...
func TestNodeV4CompatibilityMatrixMatchesSharedProtocolPolicy(t *testing.T) {
	...
	wantReleases := []string{"v0.0.1-beta1", "v0.0.1-beta2", "v0.0.1-beta3", "v0.0.1-beta4", "v0.0.1-beta5", "v0.0.1-beta6", "v0.0.1-beta7", "v0.0.1-beta8", "v0.0.1-beta9", "v0.0.1-beta10"}
	...
	for i, release := range matrix.ReleasedNodes {
		...
		if release.Version == "v0.0.1-beta5" || release.Version == "v0.0.1-beta6" || release.Version == "v0.0.1-beta7" || release.Version == "v0.0.1-beta8" || release.Version == "v0.0.1-beta9" || release.Version == "v0.0.1-beta10" {
